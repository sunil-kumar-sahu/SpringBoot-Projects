...
public class EmployeeDAOImpl implements IEmployeeDAO {
	private static final String GET_EMPS_BY_DESGS="SELECT ENO,ENAME,EJOB,ESAL FROM EMP1 WHERE EJOB IN(?,?,?) ORDER BY EJOB";
	@Autowired
			   ...
			   try(ResultSet rs=ps.executeQuery()){
				   ...
				   listEmps=new ArrayList();
				      while(rs.next()) {
				    	  ...
				    	  emp1.setEjob(rs.getString(3));
				    	  emp1.setEsal(rs.getFloat(4));
				    	  listEmps.add(emp1);
				      }//while
			   }//try2
		}//try1
