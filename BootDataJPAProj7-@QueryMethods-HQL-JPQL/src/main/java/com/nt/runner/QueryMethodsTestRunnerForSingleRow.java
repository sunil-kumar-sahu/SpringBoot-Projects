...
public class QueryMethodsTestRunnerForSingleRow implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
	   Movie movie=repo.fetchMovieDataByMname("RRR");
	   if(movie!=null)
	   ...
	   System.out.println("-----------------------------------------");
	   Object data=repo.fetchMoviePartialDataByMname("puspa");
	   ...
	   String year=repo.fetchMovieSingleDataByMname("puspa");
	   System.out.println("puspa movie release year ::"+year);
